...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-06-11 14:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5f42b1b4-12e2-4786-aaec-2e0c809fd40e.git
$ cd 5f42b1b4-12e2-4786-aaec-2e0c809fd40e
```
